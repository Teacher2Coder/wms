...
const Overview = ({ itemVarients, warehouses }) => {
  return (
    <div>
      {warehouses.length > 0 && (
        <motion.div variants={itemVarients} className="mt-16">
          {/* Header Section */}
          <div className="text-center mb-12">
            ...
            <p className="text-accent-600 text-lg max-w-2xl mx-auto">
              Get a comprehensive view of your entire warehouse network's
              inventory status and performance metrics.
            </p>
            ...
            >
              ...
              <div className="flex-grow">
                <div className="text-3xl font-bold text-accent-800 mb-1">
                  {warehouses
                    .reduce(
                      (total, warehouse) => total + warehouse.totalInventory,
                      0
                    )
                    .toLocaleString()}
                </div>
                ...
                <div className="text-xs text-accent-400 mt-2">
                  Across {warehouses.length} warehouse
              ...
              <div className="flex-grow">
                <div className="text-3xl font-bold text-accent-800 mb-1">
                  {warehouses
                    .reduce(
                      (total, warehouse) =>
                        total + warehouse.availableInventory,
                      0
                    )
                    .toLocaleString()}
                </div>
            ...
            >
              ...
              <div className="flex-grow">
                <div className="text-3xl font-bold text-accent-800 mb-1">
                  {warehouses
                    .reduce(
                      (total, warehouse) => total + warehouse.reservedInventory,
                      0
                    )
                    .toLocaleString()}
                </div>
              ...
              <div className="flex-grow">
                <div className="text-3xl font-bold text-accent-800 mb-1">
                  {warehouses
                    .reduce(
                      (total, warehouse) =>
                        total + warehouse.inTransitInventory,
                      0
                    )
                    .toLocaleString()}
                </div>
            ...
            >
              ...
              <div className="flex-grow">
                <div className="text-3xl font-bold text-accent-800 mb-1">
                  {warehouses
                    .reduce(
                      (total, warehouse) => total + warehouse.damagedInventory,
                      0
                    )
                    .toLocaleString()}
                </div>
            ...
            >
              ...
              <div className="flex-grow">
                <div className="text-3xl font-bold text-accent-800 mb-1">
                  {warehouses
                    .reduce(
                      (total, warehouse) => total + warehouse.expiredInventory,
                      0
                    )
                    .toLocaleString()}
                </div>
              ...
              <div className="flex-grow">
                <div className="text-3xl font-bold text-accent-800 mb-1">
                  {warehouses
                    .reduce(
                      (total, warehouse) =>
                        total + warehouse.outOfStockInventory,
                      0
                    )
                    .toLocaleString()}
                </div>
